...
def main(room: str):
    ...
    print("target bboxes:\n")
    target_bboxes = torch.load(f"data/GH30_{room}/all_target_bboxes.pt")
    pprint(target_bboxes)
    print("\n\npredictions:\n")
    predicted_bboxes = torch.load(f"data/GH30_{room}/predictions/batch_image2_predicted_bboxes.pt")
